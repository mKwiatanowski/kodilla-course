...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://mkwiatanowski.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("mateusz.kwiatanowski@gmail.com");
    ...
    private void deleteTaskCrudTestTask(String taskName) throws InterruptedException {
        driver.navigate().refresh();
